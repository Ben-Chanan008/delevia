...
<x-base title="View A Job">
    ...
    <div class="hero p-5 mb-5">
        <p class="text-white fs-1 fw-bold text-center">FIND YOUR NEXT JOB</p>

    </div>
    <div class="container">
        <div class="d-flex justify-content-center align-items-center">
        <form action="{{route('jobs.seeker')}}" class="w-100">
            <div class="search-bar d-flex w-75 py-2 rounded-3">
