                ...
                <div class="w-500 step-container">
                    <form id="login-form" class="w-100">
                        <div class="mb-3 step w-100">
                            <input type="email" name="email" class="p-3 form-control w-100" placeholder="Email"/>
                            <p class="error-msg text-danger"></p>
                        </div>
                        <div class="mb-3 step">
                            <input type="password" name="password" class="p-3 form-control" placeholder="Password"/>
                            <p class="error-msg text-danger"></p>
